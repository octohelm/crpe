...
""",
  ...
  String proxyFor(String s) => "https://now-proxy-3.vercel.app/";

  String downloadProxyFor(String s) => "https://ghproxy.com/";
  ...
  Future<Release> latestRelease() async {
    var resp = await client.fetch(
      Request.uri(proxyFor("$baseUrl/android/latest.json")),
    );

    var release = Release.fromJson(jsonDecode(await resp.text()));
